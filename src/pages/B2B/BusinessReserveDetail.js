...
export const BusinessReserveDetail = () => {
  ...
  const handleReserveMore = () => {
    history.push(
      `/business/services/details/${params.id}/${params.value}/${params.category}`
    );
  };
  ...
  return (
    <div className="page-container" style={{ padding: "20px 0" }}>
      <div className="reserve-detail-container">
        ...
        <div className="reserve-accions" style={{ justifyContent: "center" }}>
          <Button
            size="large"
            color="primary"
            variant="contained"
